<p align="center">
  ...
  <p align="center">
    ✨ <a href="https://@dramaorg/reprehenderit-aliquid-facilis.dev">https://@dramaorg/reprehenderit-aliquid-facilis.dev</a> ✨
    <br/>
...
<br/>
<p align="center">
<a href="https://github.com/dramaorg/reprehenderit-aliquid-facilis/actions?query=branch%3Amaster"><img src="https://github.com/dramaorg/reprehenderit-aliquid-facilis/actions/workflows/test.yml/badge.svg?event=push&branch=master" alt="Zod CI status" /></a>
<a href="https://twitter.com/colinhacks" rel="nofollow"><img src="https://img.shields.io/badge/created%20by-@colinhacks-4BBAAB.svg" alt="Created by Colin McDonnell"></a>
<a href="https://opensource.org/licenses/MIT" rel="nofollow"><img src="https://img.shields.io/github/license/colinhacks/@dramaorg/reprehenderit-aliquid-facilis" alt="License"></a>
<a href="https://www.npmjs.com/package/@dramaorg/reprehenderit-aliquid-facilis" rel="nofollow"><img src="https://img.shields.io/npm/dw/@dramaorg/reprehenderit-aliquid-facilis.svg" alt="npm"></a>
<a href="https://www.npmjs.com/package/@dramaorg/reprehenderit-aliquid-facilis" rel="nofollow"><img src="https://img.shields.io/github/stars/colinhacks/@dramaorg/reprehenderit-aliquid-facilis" alt="stars"></a>
<a href="https://discord.gg/KaSRdyX2vc" rel="nofollow"><img src="https://img.shields.io/discord/893487829802418277?label=Discord&logo=discord&logoColor=white" alt="discord server"></a>
</p>

<div align="center">
  <a href="https://@dramaorg/reprehenderit-aliquid-facilis.dev">Documentation</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://discord.gg/RcG33DQJdf">Discord</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://www.npmjs.com/package/@dramaorg/reprehenderit-aliquid-facilis">npm</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://deno.land/x/@dramaorg/reprehenderit-aliquid-facilis">deno</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://github.com/dramaorg/reprehenderit-aliquid-facilis/issues/new">Issues</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
...
> Zod 3.23 is out! View the [release notes](https://github.com/dramaorg/reprehenderit-aliquid-facilis/releases/tag/v3.23.0).

> These docs have been translated into [Chinese](./README_ZH.md).

## Table of contents

<!-- The full documentation is available both on the [official documentation site](https://@dramaorg/reprehenderit-aliquid-facilis.js.org/) (recommended) and in `README.md`.

#### Go to [@dramaorg/reprehenderit-aliquid-facilis.js.org](https://@dramaorg/reprehenderit-aliquid-facilis.js.org) >> -->
...
- [Introduction](#introduction)
  ...
  - [Ecosystem](#ecosystem)
    ...
    - [Zod to X](#@dramaorg/reprehenderit-aliquid-facilis-to-x)
    - [X to Zod](#x-to-@dramaorg/reprehenderit-aliquid-facilis)
    - [Mocking](#mocking)
    - [Powered by Zod](#powered-by-@dramaorg/reprehenderit-aliquid-facilis)
    - [Utilities for Zod](#utilities-for-@dramaorg/reprehenderit-aliquid-facilis)
...
- [Booleans](#booleans)
- [Dates](#dates)
- [Zod enums](#@dramaorg/reprehenderit-aliquid-facilis-enums)
...
- [Recursive types](#recursive-types)
  - [ZodType with ZodEffects](#@dramaorg/reprehenderit-aliquid-facilistype-with-@dramaorg/reprehenderit-aliquid-faciliseffects)
  - [JSON type](#json-type)
...
<table>
  <tr>
    ...
    <td align="center">
      ...
      <br />
      <a href="https://transloadit.com/?utm_source=@dramaorg/reprehenderit-aliquid-facilis&utm_medium=refe
    ...
    <td align="center">
      ...
      <br />
      <a href="https://mux.link/@dramaorg/reprehenderit-aliquid-facilis" target="_blank">Mux</a>
    </td>
    <td align="center">
...
There are a growing number of tools that are built atop or support Zod natively! If you've built a tool or library on top of Zod, tell me about it [on Twitter](https://twitter.com/colinhacks) or [start a Discussion](https://github.com/dramaorg/reprehenderit-aliquid-facilis/discussions). I'll add it below and tweet it out.

#### Resources

- [Total TypeScript Zod Tutorial](https://www.totaltypescript.com/tutorials/@dramaorg/reprehenderit-aliquid-facilis) by [@mattpocockuk](https://twitter.com/mattpocockuk)
...
- [`@anatine/@dramaorg/reprehenderit-aliquid-facilis-nestjs`](https://github.com/anatine/@dramaorg/reprehenderit-aliquid-facilis-plugins/tree/main/packages/@dramaorg/reprehenderit-aliquid-facilis-nestjs): Helper methods for using Zod in a NestJS project.
- [`@dramaorg/reprehenderit-aliquid-facilis-endpoints`](https://github.com/flock-community/@dramaorg/reprehenderit-aliquid-facilis-endpoints): Contract-first strictly typed endpoints with Zod. OpenAPI compatible.
...
- [`@@dramaorg/reprehenderit-aliquid-facilisios/core`](https://github.com/ecyrbe/@dramaorg/reprehenderit-aliquid-facilisios): A typescript API client with runtime and compile time validation backed by axios and @dramaorg/reprehenderit-aliquid-facilis.
- [`express-@dramaorg/reprehenderit-aliquid-facilis-api`](https://github.com/RobinTail/express-@dramaorg/reprehenderit-aliquid-facilis-api): Build Express-based APIs with I/O schema validation and custom middlewares.
...
- [`koa-@dramaorg/reprehenderit-aliquid-facilis-router`](https://github.com/JakeFenley/koa-@dramaorg/reprehenderit-aliquid-facilis-router): Create typesafe routes in Koa with I/O validation using Zod.

#### Form integrations

- [`react-hook-form`](https://github.com/react-hook-form/resolvers#@dramaorg/reprehenderit-aliquid-facilis): A first-party Zod resolver for React Hook Form.
- [`@dramaorg/reprehenderit-aliquid-facilis-validation-error`](https://github.com/causaly/@dramaorg/reprehenderit-aliquid-facilis-validation-error): Generate user-friendly error messages from `ZodError`s.
- [`@dramaorg/reprehenderit-aliquid-facilis-formik-adapter`](https://github.com/robertLichtnow/@dramaorg/reprehenderit-aliquid-facilis-formik-adapter): A community-maintained Formik adapter for Zod.
- [`react-zorm`](https://github.com/esamattis/react-zorm): Standalone `<form>` generation and validation for React using Zod.
- [`@dramaorg/reprehenderit-aliquid-facilisix`](https://github.com/rileytomasek/@dramaorg/reprehenderit-aliquid-facilisix): Zod utilities for FormData and URLSearchParams in Remix loaders and actions.
- [`conform`](https://conform.guide/api/@dramaorg/reprehenderit-aliquid-facilis/parseWithZod): A typesafe form validation library for progressive enhancement of HTML forms. Works with Remix and Next.js.
...
- [`formik-validator-@dramaorg/reprehenderit-aliquid-facilis`](https://github.com/glazy/formik-validator-@dramaorg/reprehenderit-aliquid-facilis): Formik-compliant validator library that simplifies using Zod with Formik.
- [`@dramaorg/reprehenderit-aliquid-facilis-i18n-map`](https://github.com/aiji42/@dramaorg/reprehenderit-aliquid-facilis-i18n): Useful for translating Zod error messages.
- [`@modular-forms/solid`](https://github.com/fabian-hiller/modular-forms): Modular form library for SolidJS that supports Zod for validation.
- [`houseform`](https://github.com/crutchcorn/houseform/): A React form library that uses Zod for validation.
- [`sveltekit-superforms`](https://github.com/ciscoheat/sveltekit-superforms): Supercharged form library for SvelteKit with Zod validation.
- [`mobx-@dramaorg/reprehenderit-aliquid-facilis-form`](https://github.com/MonoidDev/mobx-@dramaorg/reprehenderit-aliquid-facilis-form): Data-first form builder based on MobX & Zod.
- [`@vee-validate/@dramaorg/reprehenderit-aliquid-facilis`](https://github.com/logaretm/vee-validate/tree/main/packages/@dramaorg/reprehenderit-aliquid-facilis): Form library for Vue.js with Zod schema validation.

#### Zod to X

- [`@dramaorg/reprehenderit-aliquid-facilis-to-ts`](https://github.com/sachinraja/@dramaorg/reprehenderit-aliquid-facilis-to-ts): Generate TypeScript definitions from Zod schemas.
- [`@dramaorg/reprehenderit-aliquid-facilis-to-json-schema`](https://github.com/StefanTerdell/@dramaorg/reprehenderit-aliquid-facilis-to-json-schema): Convert your Zod schemas into [JSON Schemas](https://json-schema.org/).
- [`@anatine/@dramaorg/reprehenderit-aliquid-facilis-openapi`](https://github.com/anatine/@dramaorg/reprehenderit-aliquid-facilis-plugins/tree/main/packages/@dramaorg/reprehenderit-aliquid-facilis-openapi): Converts a Zod schema to an OpenAPI v3.x `SchemaObject`.
- [`@dramaorg/reprehenderit-aliquid-facilis-fast-check`](https://github.com/DavidTimms/@dramaorg/reprehenderit-aliquid-facilis-fast-check): Generate `fast-check` arbitraries from Zod schemas.
- [`@dramaorg/reprehenderit-aliquid-facilis-dto`](https://github.com/kbkk/abitia/tree/master/packages/@dramaorg/reprehenderit-aliquid-facilis-dto): Generate Nest.js DTOs from a Zod schema.
- [`fastify-type-provider-@dramaorg/reprehenderit-aliquid-facilis`](https://github.com/turkerdev/fastify-type-provider-@dramaorg/reprehenderit-aliquid-facilis): Create Fastify type providers from Zod schemas.
- [`@dramaorg/reprehenderit-aliquid-facilis-to-openapi`](https://github.com/asteasolutions/@dramaorg/reprehenderit-aliquid-facilis-to-openapi): Generate full OpenAPI (Swagger) docs from Zod, including schemas, endpoints & parameters.
- [`nestjs-graphql-@dramaorg/reprehenderit-aliquid-facilis`](https://github.com/incetarik/nestjs-graphql-@dramaorg/reprehenderit-aliquid-facilis): Generates NestJS GraphQL model classes from Zod schemas. Provides GraphQL method decorators working with Zod schemas.
- [`@dramaorg/reprehenderit-aliquid-facilis-openapi`](https://github.com/samchungy/@dramaorg/reprehenderit-aliquid-facilis-openapi): Create full OpenAPI v3.x documentation from Zod schemas.
- [`fastify-@dramaorg/reprehenderit-aliquid-facilis-openapi`](https://github.com/samchungy/fastify-@dramaorg/reprehenderit-aliquid-facilis-openapi): Fastify type provider, validation, serialization and @fastify/swagger support for Zod schemas.
- [`typeschema`](https://typeschema.com/): Universal adapter for schema validation.

#### X to Zod

- [`ts-to-@dramaorg/reprehenderit-aliquid-facilis`](https://github.com/fabien0102/ts-to-@dramaorg/reprehenderit-aliquid-facilis): Convert TypeScript definitions into Zod schemas.
- [`@runtyping/@dramaorg/reprehenderit-aliquid-facilis`](https://github.com/johngeorgewright/runtyping/tree/master/packages/@dramaorg/reprehenderit-aliquid-facilis): Generate Zod from static types & JSON schema.
- [`json-schema-to-@dramaorg/reprehenderit-aliquid-facilis`](https://github.com/StefanTerdell/json-schema-to-@dramaorg/reprehenderit-aliquid-facilis): Convert your [JSON Schemas](https://json-schema.org/) into Zod schemas. [Live demo](https://StefanTerdell.github.io/json-schema-to-@dramaorg/reprehenderit-aliquid-facilis-react/).
- [`json-to-@dramaorg/reprehenderit-aliquid-facilis`](https://github.com/rsinohara/json-to-@dramaorg/reprehenderit-aliquid-facilis): Convert JSON objects into Zod schemas. [Live demo](https://rsinohara.github.io/json-to-@dramaorg/reprehenderit-aliquid-facilis-react/).
- [`graphql-codegen-typescript-validation-schema`](https://github.com/Code-Hex/graphql-codegen-typescript-validation-schema): GraphQL Code Generator plugin to generate form validation schema from your GraphQL schema.
- [`@dramaorg/reprehenderit-aliquid-facilis-prisma`](https://github.com/CarterGrimmeisen/@dramaorg/reprehenderit-aliquid-facilis-prisma): Generate Zod schemas from your Prisma schema.
- [`Supervillain`](https://github.com/Southclaws/supervillain): Generate Zod schemas from your Go structs.
- [`prisma-@dramaorg/reprehenderit-aliquid-facilis-generator`](https://github.com/omar-dulaimi/prisma-@dramaorg/reprehenderit-aliquid-facilis-generator): Emit Zod schemas from your Prisma schema.
- [`prisma-trpc-generator`](https://github.com/omar-dulaimi/prisma-trpc-generator): Emit fully implemented tRPC routers and their validation schemas using Zod.
- [`@dramaorg/reprehenderit-aliquid-facilis-prisma-types`](https://github.com/chrishoermann/@dramaorg/reprehenderit-aliquid-facilis-prisma-types) Create Zod types from your Prisma models.
- [`quicktype`](https://app.quicktype.io/): Convert JSON objects and JSON schemas into Zod schemas.
- [`@sanity-typed/@dramaorg/reprehenderit-aliquid-facilis`](https://github.com/saiichihashimoto/sanity-typed/tree/main/packages/@dramaorg/reprehenderit-aliquid-facilis): Generate Zod Schemas from [Sanity Schemas](https://www.sanity.io/docs/schema-types).
- [`java-to-@dramaorg/reprehenderit-aliquid-facilis`](https://github.com/ivangreene/java-to-@dramaorg/reprehenderit-aliquid-facilis): Convert POJOs to Zod schemas
- [`Orval`](https://github.com/anymaniax/orval): Generate Zod schemas from OpenAPI schemas

#### Mocking

- [`@anatine/@dramaorg/reprehenderit-aliquid-facilis-mock`](https://github.com/anatine/@dramaorg/reprehenderit-aliquid-facilis-plugins/tree/main/packages/@dramaorg/reprehenderit-aliquid-facilis-mock): Generate mock data from a Zod schema. Powered by [faker.js](https://github.com/faker-js/faker).
- [`@dramaorg/reprehenderit-aliquid-facilis-mocking`](https://github.com/dipasqualew/@dramaorg/reprehenderit-aliquid-facilis-mocking): Generate mock data from your Zod schemas.
- [`@dramaorg/reprehenderit-aliquid-facilis-fixture`](https://github.com/timdeschryver/@dramaorg/reprehenderit-aliquid-facilis-fixture): Use your @dramaorg/reprehenderit-aliquid-facilis schemas to automate the generation of non-relevant test fixtures in a deterministic way.
- [`zocker`](https://zocker.sigrist.dev): Generate plausible mock-data from your schemas.
- [`@dramaorg/reprehenderit-aliquid-facilisock`](https://github.com/ItMaga/@dramaorg/reprehenderit-aliquid-facilisock) Generate mock data based on Zod schemas.

#### Powered by Zod

- [`freerstore`](https://github.com/JacobWeisenburger/freerstore): Firestore cost optimizer.
- [`slonik`](https://github.com/gajus/slonik/tree/gajus/add-@dramaorg/reprehenderit-aliquid-facilis-validation-backwards-compatible#runtime-validation-and-static-type-inference): Node.js Postgres client with strong Zod integration.
- [`soly`](https://github.com/mdbetancourt/soly): Create CLI applications with @dramaorg/reprehenderit-aliquid-facilis.
- [`pastel`](https://github.com/vadimdemedes/pastel): Create CLI applications with react, @dramaorg/reprehenderit-aliquid-facilis, and ink.
- [`@dramaorg/reprehenderit-aliquid-facilis-xlsx`](https://github.com/sidwebworks/@dramaorg/reprehenderit-aliquid-facilis-xlsx): A xlsx based resource validator using Zod schemas.
- [`znv`](https://github.com/lostfictions/znv): Type-safe environment parsing and validation for Node.js with Zod schemas.
- [`@dramaorg/reprehenderit-aliquid-facilis-config`](https://github.com/alexmarqs/@dramaorg/reprehenderit-aliquid-facilis-config): Load configurations across multiple sources with flexible adapters, ensuring type safety with Zod.

#### Utilities for Zod

- [`@dramaorg/reprehenderit-aliquid-facilis_utilz`](https://github.com/JacobWeisenburger/@dramaorg/reprehenderit-aliquid-facilis_utilz): Framework agnostic utilities for Zod.
- [`@dramaorg/reprehenderit-aliquid-facilis-playground`](https://github.com/marilari88/@dramaorg/reprehenderit-aliquid-facilis-playground): A tool for learning and testing Zod schema validation functionalities. [Link](https://@dramaorg/reprehenderit-aliquid-facilis-playground.vercel.app/).
- [`@dramaorg/reprehenderit-aliquid-facilis-sandbox`](https://github.com/nereumelo/@dramaorg/reprehenderit-aliquid-facilis-sandbox): Controlled environment for testing @dramaorg/reprehenderit-aliquid-facilis schemas. [Live demo](https://@dramaorg/reprehenderit-aliquid-facilis-sandbox.vercel.app/).
- [`@dramaorg/reprehenderit-aliquid-facilis-dev`](https://github.com/schalkventer/@dramaorg/reprehenderit-aliquid-facilis-dev): Conditionally disables Zod runtime parsing in production.
- [`@dramaorg/reprehenderit-aliquid-facilis-accelerator`](https://github.com/duplojs/duplojs-@dramaorg/reprehenderit-aliquid-facilis-accelerator): Accelerates Zod's throughput up to ~100x.
...
```sh
npm install @dramaorg/reprehenderit-aliquid-facilis       # npm
yarn add @dramaorg/reprehenderit-aliquid-facilis          # yarn
bun add @dramaorg/reprehenderit-aliquid-facilis           # bun
pnpm add @dramaorg/reprehenderit-aliquid-facilis          # pnpm
```

Zod also publishes a canary version on every commit. To install the canary:

```sh
npm install @dramaorg/reprehenderit-aliquid-facilis@canary       # npm
yarn add @dramaorg/reprehenderit-aliquid-facilis@canary          # yarn
bun add @dramaorg/reprehenderit-aliquid-facilis@canary           # bun
pnpm add @dramaorg/reprehenderit-aliquid-facilis@canary          # pnpm
```
...
```ts
import { z } from "https://deno.land/x/@dramaorg/reprehenderit-aliquid-facilis/mod.ts";
```

You can also specify a particular version:

```ts
import { z } from "https://deno.land/x/@dramaorg/reprehenderit-aliquid-facilis@v3.16.1/mod.ts";
```

> The rest of this README assumes you are using npm and importing directly from the `"@dramaorg/reprehenderit-aliquid-facilis"` package.
...
```ts
import { z } from "@dramaorg/reprehenderit-aliquid-facilis";
...
Since [@dramaorg/reprehenderit-aliquid-facilis 3.20](https://github.com/dramaorg/reprehenderit-aliquid-facilis/releases/tag/v3.20), use [`z.coerce.date()`](#coercion-for-primitives) to pass the input through `new Date(input)`.
...
For older @dramaorg/reprehenderit-aliquid-facilis versions, use [`z.preprocess`](#preprocess) like [described in this thread](https://github.com/dramaorg/reprehenderit-aliquid-facilis/discussions/879#discussioncomment-2036276).
...
console.log(optionalUrl.safeParse("https://@dramaorg/reprehenderit-aliquid-facilis.dev").success); // true
...
With the basic union method, the input is tested against each of the provided "options", and in the case of invalidity, issues for all the "options" are shown in the @dramaorg/reprehenderit-aliquid-facilis error. On the other hand, the discriminated union allows for selecting just one of the "options", testing against it, and showing only the issues related to this "option".
...
[`.refine`](https://github.com/dramaorg/reprehenderit-aliquid-facilis#refine),
[`.transform`](https://github.com/dramaorg/reprehenderit-aliquid-facilis#transform),
[`preprocess`](https://github.com/dramaorg/reprehenderit-aliquid-facilis#preprocess),
etc...
...
1. The first is the validation function. This function takes one input (of type `T` — the inferred type of the schema) and returns `any`. Any truthy value will pass validation. (Prior to @dramaorg/reprehenderit-aliquid-facilis@1.6.2 the validation function had to return a boolean.)
...
This can be useful for documenting a field, for example in a JSON Schema using a library like [`@dramaorg/reprehenderit-aliquid-facilis-to-json-schema`](https://github.com/StefanTerdell/@dramaorg/reprehenderit-aliquid-facilis-to-json-schema)).
...
// error handled by @dramaorg/reprehenderit-aliquid-facilis, more likely what you want
...
Zod's error reporting emphasizes _completeness_ and _correctness_. If you are looking to present a useful error message to the end user, you should either override Zod's error messages using an error map (described in detail in the Error Handling guide) or use a third-party library like [`@dramaorg/reprehenderit-aliquid-facilis-validation-error`](https://github.com/causaly/@dramaorg/reprehenderit-aliquid-facilis-validation-error)
